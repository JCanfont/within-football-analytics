...
class Match(TimestampMixin, Base):
    ...
    home_odds: Mapped[Decimal | None] = mapped_column(Numeric(8, 3))
    draw_odds: Mapped[Decimal | None] = mapped_column(Numeric(8, 3))
    away_odds: Mapped[Decimal | None] = mapped_column(Numeric(8, 3))
    odds_source: Mapped[str | None] = mapped_column(String(80))
